  ...
  return (
    <div
      ...
      style={{
        ...
        animation: showSeedEffect
          ? 'levelUpFlash 0.8s ease-out'
    ...
    >
      ...
      >
        <div
          style={{
            ...
            filter:
              treeLevel >= 3
                ? `drop-shadow(0 0 8px ${currentStage.color}44)`
                : 'none',
          }}
        >
      ...
      >
        ...
        >
          <Droplets
            size={20}
            fill={canAfford ? 'rgba(255,255,255,0.2)' : 'none'}
          />
        </button>
        <div
          style={{
